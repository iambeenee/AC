...
public class Example {
	...
	public static void main(String[] args) {
		...
		System.out.println("학생 " + studentHong.getName() + "의 총 점수는 " + studentHong.getTotal() + "이고, 평군은 "
