...
<body>
				...
				<div>
					<table border="1" id="contents">
						<thead>
							<tr>
								<th width="150">
									<span style="color:red" onclick="sortBorder('A')">A </span>글번호<span style="color:red" onclick="sortBorder('D')"> D</span>
								</th>
								<th width="150">작성자</th>
								<th width="300">제 목</th>
	...
	<script type="text/javascript">
		...
		function searchResult(data){ //json객체를 html로 변환 후 화면에 적용
			var tb = $("#borderBody");
			$("#borderBody").empty();
