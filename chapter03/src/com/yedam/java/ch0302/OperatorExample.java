...
public class OperatorExample {
	...
	//산술연산자
		...
		System.out.println("<문자열 결합 연산자>");
	//문자열 결합 연산자
		String str1 = "JDK" + 6.0;
		String str2 = str1 + " 특징";
		System.out.println(str2);
		
		String str3 = "JDK" + 3 + 3.0; // -> 모두 문자열 인식
		String str4 = 3 + 3.0 + "JDK"; // -> 앞은 연산자로 인식
	...
	//비교연산자
		...
		boolean bResult4 = (char1 < char2); //유니코드 정수값으로 처리
		...
		System.out.println((float)v5 == v6); //타입변환으로 맞춰주기
	...
	//논리연산자
		...
		if((charCode>=65) & (charCode<=90)) { //앞 뒤 둘다 연산
			System.out.println("대문자");
		}
		
		//유니코드 중 97보다 크거나 같으며 122보다 작거나 같으면 소문자
		if((charCode>=97) && (charCode<=122)) { // 앞에 false 걸리면 뒤에 연산 x 
			System.out.println("소문자");
		}
		
		//유니코드 중 48보다 크고 57보다 작으면 숫자 0~9
		if((charCode>48) && (charCode<57)) { // 뒤에 false 걸려서 연산 x
			System.out.println("숫자 0~9");
		}
		
		//OR 연산자
		int numValue = 9; //11 -> false로 결과값 도출 x
		
		if((numValue % 2 == 0) || (numValue % 3 == 0)) { 
			System.out.println("2의 또는 3의 배수입니다.");
		}
