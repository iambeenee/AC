...
public class ExceptionExample {
	public static void main(String[] args) {
		 ...
		 * 
		 * System.out.println("args[0]" + data1); System.out.println("args[1]" + data2);
		 */
		if (args.length == 2) {
			String data1 = args[0];
			String data2 = args[1];
			...
			System.out.println("args[1]" + data2); // ->예외발생
		} else {
		 ...
		 * 
		 * int result = value1 + value2; System.out.println(value1 + "+ " + value2 +
		 * " = " + result);
		 */
